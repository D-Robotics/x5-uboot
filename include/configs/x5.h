...
#define RDK_DEFAULT_ION_TOTAL_SIZE (0x30000000u) /* 768MiB */
#define RDK_DEFAULT_ION_RESERVED_SIZE (0x14000000u) /* 320MiB */
#define RDK_DEFAULT_ION_CARVEOUT_SIZE (0x14000000u) /* 320MiB */
#define RDK_DEFAULT_ION_CMA_SIZE \
	(RDK_DEFAULT_ION_TOTAL_SIZE - RDK_DEFAULT_ION_RESERVED_SIZE - \
	RDK_DEFAULT_ION_CARVEOUT_SIZE) /* 128M */
