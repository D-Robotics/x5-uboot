...
#define DS_LSIO_UART0_TX  9
#define DS_LSIO_UART0_RX  1
#define DS_LSIO_UART0_CTS 25
#define DS_LSIO_UART0_RTS 17
...
#define ST_LSIO_UART0_RX  BIT(0)
#define ST_LSIO_UART0_TX  BIT(8)
#define ST_LSIO_UART0_RTS BIT(16)
#define ST_LSIO_UART0_CTS BIT(24)
...
#define PU_LSIO_UART0_RX  BIT(6)
#define PU_LSIO_UART0_TX  BIT(14)
#define PU_LSIO_UART0_RTS BIT(22)
#define PU_LSIO_UART0_CTS BIT(30)
...
#define PD_LSIO_UART0_RX  BIT(5)
#define PD_LSIO_UART0_TX  BIT(13)
#define PD_LSIO_UART0_RTS BIT(21)
#define PD_LSIO_UART0_CTS BIT(29)
...
static const struct horizon_pin_desc horizon_lsio_pins_desc[] = {
	...
	_PIN(LSIO_UART0_RX, "lsio_uart0_rx", LSIO_PINCTRL_4, LSIO_PINCTRL_4, DS_LSIO_UART0_RX,
	     INVALID_PULL_BIT, INVALID_PULL_BIT, PU_LSIO_UART0_RX, PD_LSIO_UART0_RX,
	     ST_LSIO_UART0_RX, MS_LSIO_UART0),
	_PIN(LSIO_UART0_TX, "lsio_uart0_tx", LSIO_PINCTRL_4, LSIO_PINCTRL_4, DS_LSIO_UART0_TX,
	     INVALID_PULL_BIT, INVALID_PULL_BIT, PU_LSIO_UART0_TX, PD_LSIO_UART0_TX,
	     ST_LSIO_UART0_TX, MS_LSIO_UART0),
	_PIN(LSIO_UART0_RTS, "lsio_uart0_rts", LSIO_PINCTRL_4, LSIO_PINCTRL_4,
	     DS_LSIO_UART0_RTS, INVALID_PULL_BIT, INVALID_PULL_BIT, PU_LSIO_UART0_RTS,
	     PD_LSIO_UART0_RTS, ST_LSIO_UART0_RTS, MS_LSIO_UART0),
	_PIN(LSIO_UART0_CTS, "lsio_uart0_cts", LSIO_PINCTRL_4, LSIO_PINCTRL_4,
	     DS_LSIO_UART0_CTS, INVALID_PULL_BIT, INVALID_PULL_BIT, PU_LSIO_UART0_CTS,
	     PD_LSIO_UART0_CTS, ST_LSIO_UART0_CTS, MS_LSIO_UART0),
